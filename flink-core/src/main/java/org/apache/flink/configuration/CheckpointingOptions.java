...
public class CheckpointingOptions {
    ...
    public static final ConfigOption<Boolean> TASK_INSTANCE_RECOVERY =
            ConfigOptions.key("state.backend.task-instance-recovery")
                    .defaultValue(false)
                    .withDescription(
                            "This option configures whether task instance recovery is enabled or not. "
                                    + "Operator instances running inside a snapshot region can be recovered per parallel instance basis rather than recovers all parallel instances");

    public static final ConfigOption<Integer> MAX_GENERATED_SNAPSHOT_REGIONS =
            ConfigOptions.key("state.backend.max-generated-snapshot_regions")
                    .defaultValue(0)
                    .withDescription(
                            "The config parameter defining the number of maximum snapshot regions to be generated automatically. "
                                    + "Setting this parameter value to positive integer will create snapshot regions which do not contain stream edge with ALL_TO_ALL distribution patterns, "
                                    + "as well as overwriting any custom defined snapshot regions. "
                                    + "The snapshot regions are generated by traversing the StreamGraph starting from the Sink.");
