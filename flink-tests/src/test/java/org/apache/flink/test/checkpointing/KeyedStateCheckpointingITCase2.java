...
public class KeyedStateCheckpointingITCase2 extends TestLogger {
    ...
    static boolean checkpointHappened;
     ...
     * happened.
     */
    private class IntGeneratingSourceFunction extends RichParallelSourceFunction<Integer>
