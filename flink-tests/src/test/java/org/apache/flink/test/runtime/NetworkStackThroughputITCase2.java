...
public class NetworkStackThroughputITCase2 extends TestLogger {

    private static final Logger LOG = LoggerFactory.getLogger(NetworkStackThroughputITCase2.class);
            ...
            try {
                ...
                int dataVolumeGb =
                        getTaskConfiguration()
                                .getInteger(
                                        NetworkStackThroughputITCase2.DATA_VOLUME_GB_CONFIG_KEY, 1);
    ...
    public static void main(String[] args) throws Exception {
        new NetworkStackThroughputITCase2().testThroughput();
